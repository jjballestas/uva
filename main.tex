...
% % % % % METODOLOGÍA % % % % %
    ...
    En este caso se puede visualizar lo analizado en la exploración de datos, al haber tanto desbalance en la clase,
el modelo predice de manera excelente para la clase mayoritaria, pero para la minoritaria tiene un comportamiento
bastante pobre en algunas combinaciones peor que aleatoreo.
