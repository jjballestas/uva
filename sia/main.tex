...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \textbf{{\Large Diseño de sistemas de interacción avanzada }\\[0.5cm]}
...
% Cuerpo
    ...
    La ausencia de personal especializado en sonido, la necesidad de autogestión del audio generan situaciones
    ...
    \vspace*{\fill}
    \section{\large Problema}

    \subsection{Problema inicialmente abordado}
    Usuarios que dependen de amplificación para su trabajo como pequeños grupos musicales, dúos, solistas o
    conferencistas independientes que se presentan en bares, casas o salas se enfrentan a problemas de sonido antes
    y durante sus presentaciones, como feedback, niveles mal calibrados, saturación u otro debido a la falta de un
    ...
    Para plantear el problema de manera inicial se han identificado las siguientes suposiciones tanto de usuarios
    como del problema.
    \subsubsection{Suposiciones sobre usuarios}
    \paragraph{Bandas independientes, dúos y solistas}
    Formaciones pequeñas (hasta 5) que se autofinancian y tocan en bares, salas y eventos.
    Suelen operar sin técnico de sonido dedicado y con equipo propio básico (consola sencilla, amplificación y micros).
    \begin{itemize}
        \item \textbf{Deseos}: Sonar profesional y consistente para crecer en audiencia e ingresos.
        Poder concentrarse en tocar sin “vigilar” el audio o como el público lo percibe.
        \item \textbf{Miedos}: Feedback inesperado, voz enterrada o poco clara, mezcla desbalanceada.
        Cambios acústicos cuando entra el público y poca capacidad de corrección en tiempo real sin cortar el show.
        Perder fans y audiencia debido a presentaciones pobres de calidad.
        \item \textbf{Criterios de éxito}: Montaje plug \& play en 15 a 20 min; mezcla estable que se adapte por
        canción; buen
        feedback del público; recontratación.
        \item \textbf{Contexto y Comentarios}: Tocan entre dos y seis veces al mes en diferentes espacios de 50\-200
        personas
        sin tratamiento acústico, con repertorios de diez a veinte canciones que varían en dinámica.
        Sus conocimientos van desde lo básico hasta intermedio, pero sin tiempo para ajustes finos durante el show.
        Su presupuesto es ajustado y necesitan compatibilidad con su equipo actual, portabilidad y robustez.
    \end{itemize}

    \paragraph{Conferencistas y actos hablados}
    Speakers corporativos, stand-up, open mic.
    No son técnicos; solo quieren que la voz se entienda en toda la sala.
    \begin{itemize}
        \item \textbf{Deseos}: Enfoque total en el contenido y la conexión con la audiencia.
        \item \textbf{Miedos}: Feedback vergonzoso, baja inteligibilidad, interfaces confusas, pérdida de credibilidad por fallos.
        \item \textbf{Criterios de éxito}: Presentación sin incidentes de audio; comentarios sobre el contenido, no sobre el sonido.
        \item \textbf{Contexto y Comentarios}: Dan entre una y cuatro presentaciones al mes en salas y auditorios pequeños
        con acústica muy variable, cada una de treinta a noventa minutos.
        No tienen conocimientos de audio y requieren una solución completamente automática en menos de cinco minutos
        y sin interacción durante la charla.
    \end{itemize}

    \subsubsection{Suposiciones sobre el problema}
    \begin{itemize}
        \item Los usuarios tendrán al menos conocimientos básicos sobre el uso de equipos tecnológicos y de sonido.
        \item Las bandas, dúos o solistas tendrán material de audio aceptable (grabaciones o pistas) que sirva como
        referencia para configurar el sistema.
        \item El orden de las canciones será predecible o planificado con antelación, facilitando los ajustes
        automáticos del sistema.
        \item Los grupos preferirán tener retroalimentación sobre cómo se percibe el sonido en el público, en lugar de
        sentirse presionados o distraídos por ello.
        \item Los músicos estarán dispuestos a ceder parte del control de la mezcla a un sistema automático o semiautomático.
        \item Los espacios donde se realizan las presentaciones permitirán la instalación y conexión rápida del sistema
    ...
    \newpage
    \section{\large Fase de descubrimiento}
    ...
    \paragraph{Técnicas de recogida de datos}
    ...
    \paragraph{Participantes más adecuados para adquirir conocimiento:}
    ...
    \subsubsection{Evento de investigación}
    ...
    \paragraph{Grupo de covers bajo contrato con 5 integrantes}
    ...
    Para este grupo de usuarios se coordinó la investigación con el grupo “Los Caimanes del Esgueva”\ref{fig:caimanes},
    ...
    \paragraph{Grupo profesional de 4 integrantes}
    ...
    Para este grupo de usuarios se coordinó la investigación con el grupo “Cañoneros”\ref{fig:canoneros}, se realizó la
    coordinación de
    ...
    \paragraph{Grupo de música independiente autofinanciado de 3 integrantes}
    ...
    Para este grupo de usuarios se coordinó la investigación con el grupo “AROWANA”\ref{fig:arowana}, se realizó la
    coordinación de
    la entrevista mediante un mensaje privado en Instagram, en donde fueron muy amables de aceptarla.
    ...
    \paragraph{Dueño del bar y dependientes}
    ...
    Se entrevistó al dueño del bar Radial y a la dependienta del bar Zvmo\ref{fig:duenos}.
    \myparagraph{Observaciones realizadas:}
    ...
    \paragraph{Dúo musical bajo contrato de covers y originales}
    ...
    \paragraph{Conferencista independiente}
    Se coordinó la entrevista mediante Instagram y fue realizada a través de llamada telefónica.
    ...
    \subsubsection{Objetivo y Fases de las entrevistas}
    El objetivo principal de las entrevistas\ref{fig:guia-entrevista} era entender detalladamente las metas, retos y necesidades
    técnicas y
    ...
    el equipo y el público para descartar usuarios y recabar información útil para el diseño

    \paragraph{Fases de la entrevista}
    \begin{figure}[H]
        \centering
        \begin{tcolorbox}[
            width=0.8\textwidth,
            colback=white,
            colframe=black,
            title={Fases de la entrevista},
            fonttitle=\bfseries\large,
            center title
        ]
            \textbf{1. Contexto y Objetivos}\\
            \quad - Metas\\
            \quad - Lugares y frecuencia\\
            \quad - Éxito\\[0.1cm]
            \textbf{2. Retos y Responsabilidades}\\
            \quad - Dificultades y estrés\\
            \quad - Control sonido\\[0.1cm]
            \textbf{3. Habilidades Técnicas}\\
            \quad - Experiencia equipos\\
            \quad - Herramientas\\[0.1cm]
            \textbf{4. Automatización y Feedback}\\
            \quad - Aspectos a automatizar\\
            \quad - Retroalimentación\\
            \quad - Resolución\\[0.1cm]
            \textbf{5. Cierre y Mejoras}\\
            \quad - Sugerencias\\
            \quad - Perspectivas futuras
        \end{tcolorbox}
        \caption{Fases de entrevista para grupos de usuarios}
        \label{fig:guia-entrevista}
    \end{figure}
    ...
    El análisis se realizó con la metodología de Análisis Temático (Thematic Analysis), en el cual se
    analizaron los datos extrayendo las partes más relevantes de las transcripciones, clasificándolas posteriormente
    ...
    \href{https://miro.com/app/board/uXjVJAPP6xA=/?moveToWidget=3458764645785384622\&cot=14}{[Tablero Miro]}

    \subsubsection{Conclusión del análisis de datos}
    La investigación permitió contrastar las suposiciones iniciales sobre los perfiles de usuario y profundizar en
    ...
    En primer lugar, se confirmó que los conferencistas no priorizan el sonido en su trabajo, lo que lleva a
    ...
    Los resultados validan que la mayoría de los músicos posee solo conocimientos técnicos básicos.
    ...
    Respecto a las bandas de covers y grupos bajo contrato, se comprobó que el sonido es un factor crítico para su
    ...
    Por otra parte, los datos sobre dueños y empleados de bares fueron menos concluyentes, debido a la limitada
    ...
    Finalmente, se identificó una preocupación compartida por músicos y dueños de locales respecto al cumplimiento
    ...
    \paragraph{Grupo ideal de usuarios a partir de análisis realizado:}

    Se puede definir que el grupo de usuarios más adecuado para continuar el desarrollo
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{./assets/persona}
        \caption{Eddie - Persona definida}
        \label{fig:persona}
    \end{figure}

    Acorde al análisis de datos hemos definido a la persona Eddie\ref{fig:persona} para continuar con el diseño del
    sistema propuesto.
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{./assets/empatia}
        \caption{Mapa de empatía}
        \label{fig:empatia}
    \end{figure}

    El mapa de empatía de Eddie\ref{fig:empatia} permitió comprender a fondo cómo piensa, siente y actúa durante sus
    presentaciones en
    vivo.
    ...
    El mapa de recorrido a continuación\ref{fig:recorridoPresente} describe el comportamiento del usuario con base en su situación
    actual.
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{./assets/recorrido-presente}
        \caption{Mapa de recorrido - Presente}
        \label{fig:recorridoPresente}
    \end{figure}

    \newpage
    \section{\large Fase de ideación y evaluación}
    ...
    Este mapa de recorrido\ref{fig:recorridoFuturo} describe el comportamiento deseado de un usuario ante el sistema basado en esta
    solución.
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{./assets/recorrido-futuro}
        \caption{Mapa de recorrido - Futuro}
        \label{fig:recorridoFuturo}
    \end{figure}

    \paragraph{Escenario 2 (durante el show y monitoreo) para esta solucion:}

    Durante la presentación, Eddie nota que el sonido empieza a saturarse cuando el público se acerca al escenario.
    En la tablet aparece una alerta amarilla que indica exceso de graves en el canal del bajo.

    Como la calibración automática está activa, el sistema ajusta los parámetros en tiempo real, estabilizando el
    sonido sin que la banda deba detenerse.
    El público apenas nota el cambio y la actuación continúa sin incidentes.
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{./assets/sistema}
        \caption{Smart Sound componentes básicos}
        \label{fig:sistema}
    \end{figure}
    ...
    \begin{itemize}
        ...
        visual, cargar presets y guardar calibraciones personalizadas\ref{fig:sistema}.
    \end{itemize}
    ...
    \newpage
    \section{\large Aspectos no tratados, cuestiones a seguir investigando}
